...
public class Main {
    ...
    private static void testCombatSystem() {
        ...
        Enemy goblin = new Enemy("Goblin", 50, 10, 3, 25, 8);
    ...
    private static void testRewardAndLevelUpSystem() {
        ...
        System.out.println(player);
        System.out.println("Experience before fight: " + player.getExperience());
        System.out.println("Gold before fight: " + player.getGold());

        game.nextTurn();

        System.out.println("Player after boss fight:");
        System.out.println(player);
        System.out.println("Experience after fight: " + player.getExperience());
        System.out.println("Gold after fight: " + player.getGold());
    ...
    private static void testHealingPotionSystem() {
        ...
        System.out.println("Health after damage: " + player.getCurrentHealth());

        player.useItem(potion);
        System.out.println("Health after potion: " + player.getCurrentHealth());
    ...
    private static void testWeaponEquipSystem() {
        ...
        System.out.println("Attack before equip: " + player.getAttack());
        sword.equip(player);
        System.out.println("Attack after equip: " + player.getAttack());
